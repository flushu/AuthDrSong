      ...
      <div className="header_col1">
        <div className="group">
          ...
          <div className="header_col1_row2">
            <div>
              <label><input type="checkbox" checked={this.state.location.includes("Los Alamitos")} /> Los Alamitos</label>
              <label><input type="checkbox" checked={this.state.location.includes("Pasadena")} /> Pasadena</label>
            </div>
            <div>
              <label><input type="checkbox" checked={this.state.provider.includes("Alice Song")} /> Alice Song, M.D.</label>
              <label><input type="checkbox" checked={this.state.provider.includes("Julia Song")} /> Julia Song, M.D.</label>
            </div>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="header_col2">
        <div>
          ...
          <input type="checkbox" checked={this.state.type.includes("F/U")} /> F/U
          <input type="checkbox" checked={this.state.type.includes("P/O")} /> P/O
          <input type="checkbox" checked={this.state.type.includes("SX")} /> SX
        </div>
        <div>
          <textarea cols={60} rows={3} value={this.state.note} onChange={(e)=>{
    ...
    return (
      <div className="header_col3">
        <div className="group">
          ...
          <div>Apt Time: <input id="apt_time_input" type="text" value={this.state.apt_time}
            onChange={(e)=>{
...
const Row2 = () => (
  <div className="header_row2">
    Legends: // Eye(E): 1 OD, 2 OS, 3 OU // Lid(L): 1 RUL, 2 RLL, 4 LUL, 5 LLL // X: space holder // Y Severity: 1 mid, 2 moderate, 3 severe // Z encouter: A initial, D subsequent, S sequelac
  </div>
);
